...
<template>
  <div
    ...
    @click="
      () => {
        if (!disabled && player.id !== user.id) {
          $emit('click', player.id);
        }
      }
    "
  >
    <div class="player__container">
      <div class="player__profile">
        ...
        <p class="player__pseudo" v-else>
          {{ t('empty') }}
        </p>
      </div>
      <div class="player__host" v-if="player.role === 'host'">
        <svg
